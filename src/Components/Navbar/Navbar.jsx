            ...
            <nav>
                <div className={styles.navbar_left}>
                    ...
                    <div className={styles.dropdown_div}>
                        <button className={styles.btn_nav}>Features</button>
                        <svg width="15" height="6" xmlns="http://www.w3.org/2000/svg"><path stroke="#686868" stroke-width="1.5" fill="none" d="m1 1 4 4 4-4"/></svg>
                        <div className={styles.dropdown_content_div}>
                        <a href="#">
                    ...
                    <div className={styles.dropdown_div}>
                        <button className={styles.btn_nav}>Company</button>
                        <svg width="15" height="6" xmlns="http://www.w3.org/2000/svg"><path stroke="#686868" stroke-width="1.5" fill="none" d="m1 1 4 4 4-4"/></svg>
                        <div className={styles.dropdown_content_div}>
                        <a href="#">History</a>
                        <a href="#">Our Team</a>
                    ...
                    <button className={styles.btn_nav}>Careers</button>
                    <button className={styles.btn_nav}>About</button>
                </div>
                <div className={styles.navbar_right}>
                    <button className={styles.btn_nav}>Login</button>
                    <button className={styles.btn_reg}>Register</button>
                </div>
                ...
                <div className={active ? styles.ham_options : styles.ham_options_off}>
                    <div className={styles.ham_options_div}>
                        <div className={styles.dropdown_div_ham}>
                            <div>
                                <button className={styles.btn_nav_ham}>Features</button>
                                <svg width="15" height="6" xmlns="http://www.w3.org/2000/svg"><path stroke="#686868" stroke-width="1.5" fill="none" d="m1 1 4 4 4-4"/></svg>
                            </div>
                            <div>
                                <div className={styles.dropdown_content_div_ham}>
                                <a href="#">
                                    <svg width="14" height="16" xmlns="http://www.w3.org/2000/svg"><path d="M14 3v12a1 1 0 0 1-1 1H1a1 1 0 0 1-1-1V3a1 1 0 0 1 1-1h1V1a1 1 0 1 1 2 0v1h2V1a1 1 0 1 1 2 0v1h2V1a1 1 0 0 1 2 0v1h1a1 1 0 0 1 1 1Zm-2 3H2v1h10V6Zm0 3H2v1h10V9Zm0 3H2v1h10v-1Z" fill="#726CEE"/></svg>
                                    Todo List
                                </a>
                        ...
                        <div className={styles.dropdown_div_ham}>
                            <div>
                                <button className={styles.btn_nav_ham}>Company</button>
                                <svg width="15" height="6" xmlns="http://www.w3.org/2000/svg"><path stroke="#686868" stroke-width="1.5" fill="none" d="m1 1 4 4 4-4"/></svg>
                            </div>
                            <div>
                                <div className={styles.dropdown_content_div_ham}>
                        ...
                        <button className={styles.btn_nav_ham}>Careers</button>
                        <button className={styles.btn_nav_ham}>About</button>
                        <button className={styles.btn_nav_ham}>Login</button>
                        <button className={styles.btn_reg_ham}>Register</button>
                    </div>
                </div>
            </nav>
        </div>
